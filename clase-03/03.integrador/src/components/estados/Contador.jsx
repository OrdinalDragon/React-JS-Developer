...
const Contador = ({ valorInicial:vi }) => {
    ...
    // * A partir de la versiónn 16.6 de react aparecieron los hooks (ganchos) que permite de una manera sencilla agregar un estado a las funciones de js. Enganchar la función al core de React.
    ...
    const handleIncrementar = () => {
        ...
        // Esta función además de modificar la variable (estado) notifica o avisa a react que tiene que volver a ejecutar la función (renderizar el componente)
    }
  ...
  return (
    <>
        <h2 className="text-4xl">Contador: 
